...
/**
 * Simple memory-based Cache pool item.
 * Implementation of the PSR-Cache proposal.
 * @author norv@simplemachines.org
 */
class MemoryCacheItem extends CacheItem
{
	/**
	 * This item's pool
	...
	public function remove()
	{
		...
		// the Pool will do the work with the underlying library
		$this->_value = null;
		$this->_miss = true;
		$this->_pool->removeItem($this->_key);
	}
